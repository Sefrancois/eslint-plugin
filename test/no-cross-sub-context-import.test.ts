...
import { NoCrossSubContextImport } from "../src/no-cross-sub-context-import";
...
const rulesOptions = [[
	{
		namedSubContext: "extraction",
		forbiddenSubContextImport: ["chargement", "transformation"]
	}, {
		namedSubContext: "transformation",
		forbiddenSubContextImport: ["chargement", "extraction"]
	}, {
		namedSubContext: "chargement",
		forbiddenSubContextImport: ["extraction", "transformation"]
	}
]];
